...
export default function App() {
  ...
  const [sharedData, setSharedData] = useState<Array<Record<string, any>> | null>(null);
  ...
  return (
    <div className="h-screen overflow-hidden bg-background flex flex-col">
      ...
      {/* Main content */}
      <div className="max-w-[1400px] mx-auto flex flex-col min-h-0 w-full" style={{ height: 'calc(100vh - 80px)', paddingTop: '16px', paddingBottom: '16px', paddingLeft: '16px', paddingRight: '16px', boxSizing: 'border-box', minWidth: 0, overflow: 'hidden' }}>
        <CsvDataTable
